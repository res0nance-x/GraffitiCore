`GraffitiCore` implements P2P networking protocols for [Graffiti-PC](https://github.com/res0nance-x/Graffiti-PC) and [Graffiti-Android](https://github.com/res0nance-x/Graffiti-Android), the REST/HTTP API layer, and houses the cross-platform Web application assets.

* **Web UI & Build Tooling**:
  * Built with TypeScript (ES2022 output) via Gradle task `compileTypescript` (`npx tsc`).
  * Source located at GraffitiCore/src/main/resources/web
